...
directory_mergerFrame::directory_mergerFrame(wxWindow* parent,wxWindowID id)
{
    ...
    TextFirstDirectory = new wxTextCtrl(MainPanel, ID_TEXTCTRL1, wxEmptyString, wxPoint(8,40), wxSize(432,24), 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    ButtonFirstDirectory = new wxButton(MainPanel, ID_BUTTON1, _("..."), wxPoint(448,40), wxSize(24,24), 0, wxDefaultValidator, _T("ID_BUTTON1"));
    StaticText2 = new wxStaticText(MainPanel, ID_STATICTEXT2, _("Directory 2:"), wxPoint(8,96), wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    TextSecondDirectory = new wxTextCtrl(MainPanel, ID_TEXTCTRL2, wxEmptyString, wxPoint(8,120), wxSize(432,24), 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
    TextSecondDirectory->SetMaxSize(wxSize(-1,-1));
    ButtonSecondDirectory = new wxButton(MainPanel, ID_BUTTON2, _("..."), wxPoint(448,120), wxSize(24,24), 0, wxDefaultValidator, _T("ID_BUTTON2"));
    StaticLine1 = new wxStaticLine(MainPanel, ID_STATICLINE1, wxPoint(8,160), wxSize(464,2), wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
    StaticText3 = new wxStaticText(MainPanel, ID_STATICTEXT3, _("Output Directory:"), wxPoint(8,192), wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    TextOutputDirectory = new wxTextCtrl(MainPanel, ID_TEXTCTRL3, wxEmptyString, wxPoint(8,216), wxSize(432,24), 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
    ButtonOutputDirectory = new wxButton(MainPanel, ID_BUTTON3, _("..."), wxPoint(448,216), wxSize(24,24), 0, wxDefaultValidator, _T("ID_BUTTON3"));
    StaticLine2 = new wxStaticLine(MainPanel, ID_STATICLINE2, wxPoint(8,264), wxSize(464,2), wxLI_HORIZONTAL, _T("ID_STATICLINE2"));
    StaticBox1 = new wxStaticBox(MainPanel, ID_STATICBOX1, _("Settings"), wxPoint(16,296), wxSize(448,80), 0, _T("ID_STATICBOX1"));
    CopyRadioButton = new wxRadioButton(MainPanel, ID_RADIOBUTTON1, _("Copy"), wxPoint(32,328), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
    MoveRadioButton = new wxRadioButton(MainPanel, ID_RADIOBUTTON2, _("Move"), wxPoint(104,328), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
    ButtonMergeDirectories = new wxButton(MainPanel, ID_BUTTON4, _("Merge Directories"), wxPoint(166,424), wxSize(144,44), 0, wxDefaultValidator, _T("ID_BUTTON4"));
	...
	SetMinClientSize(wxSize(479, 518));
	SetMaxClientSize(wxSize(479, 518));
